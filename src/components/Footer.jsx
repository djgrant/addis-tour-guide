...
function WhatsAppIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true" style={{ flexShrink: 0 }}>
          ...
          <address style={{ fontStyle: 'normal' }}>
            <p>
              <a
                ...
                className="footer-link footer-contact-item footer-whatsapp"
